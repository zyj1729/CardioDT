...
tree = ET.parse('/Users/zhangyujie/Desktop/NanoTools Bioscience/test_trackmate_script.xml')
root = tree.getroot()
...
min_square_mov = 4
with open("/Users/zhangyujie/Desktop/NanoTools Bioscience/sorted_roi.txt", "w") as text_file:
